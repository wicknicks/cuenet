...
(function($) {
    ...
    $.fn.annotateImage = function(options) {
        ...
        if (this.editable) {
            this.button = $('<a class="image-annotate-add" id="image-annotate-add" href="#">Mark Face</a>');
    ...
    **/
    ...
    $.fn.annotateImage.ajaxLoad = function(image) {
        ...
        $.getJSON(image.getUrl + params['pic'], function(data) {
        
            delete data['_id'];
            var sdata = JSON.stringify(data);
            sdata = sdata.replace(/,/g, ',\n');
            var eptContent = "<br><br> <pre class=prettyprint>";
            $('#content').append('<br><br><pre class="prettyprint">' + sdata + '</pre>');
          
            for (var i=0; i<data.faces.length; i++) {
              data.faces[i].text  = "Enter Name";
              data.faces[i].editable = true;
            }
            
            image.notes = data.faces;
            
            //image.notes = data;  //commented by [arjun]
    ...
    $.fn.annotateImage.createSaveButton = function(editable, image, note) {
        ...
        ok.click(function() {
            ...
            if (image.useAjax) {
                $.ajax({
                    url: image.saveUrl,
                    data: form.serialize() + "&pic="+getURLParams()['pic'],
